...
#define SABRESD_CSI0_PWN	IMX_GPIO_NR(1, 19)//IMX_GPIO_NR(1, 16)
#define SABRESD_CSI0_RST  IMX_GPIO_NR(1, 2)
...
#define SABRESD_CHARGE_DOK_B  IMX_GPIO_NR(3, 17)
#define SABRESD_ECSPI2_CS1  IMX_GPIO_NR(2, 27)
...
#define SABRESD_CHARGE_CHG_1_B    IMX_GPIO_NR(3, 18)
#define SABRESD_TS_INT        IMX_GPIO_NR(3, 20)
...
#define SABRESD_LVDS_PWREN	IMX_GPIO_NR(6, 15)
...
#if defined(CONFIG_CAN_MCP251X)
#define CAN_IRQGPIO    IMX_GPIO_NR(2, 21)
#endif

#define LVDS_VDD_EN	IMX_GPIO_NR(1, 27)
#define L_BKLT_EN	IMX_GPIO_NR(1, 29)
/* SPI1-GPIO */
...
#define PHY_MDC                IMX_GPIO_NR(1, 22)
#define PHY_MDIO                 IMX_GPIO_NR(1, 31) 
	gpio_request(PHY_MDIO, "phy_mdio");
	gpio_request(PHY_MDC, "phy_mdc");
	gpio_direction_output(PHY_MDC, 1);
        gpio_direction_output(PHY_MDIO, 1);
        udelay(1000);
#endif
	gpio_request(SABRESD_RGMII_RST, "rgmii_rst");
...
#endif
	gpio_request(LVDS_VDD_EN, "lvds_vdd_en");
	gpio_direction_output(LVDS_VDD_EN, 1);
	gpio_request(L_BKLT_EN, "l_bklt_en");
	gpio_direction_output(L_BKLT_EN, 1);
